        ...
        <div class="container gutter-top">
                ...
                <div class="header__left">
                    ...
                    <div class="header__base-info">
                        ...
                        <ul class="header__social">
                            ...
                            <li>
                                <a href="https://github.com/AdennyFernandes/Curso-Ifes">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/channel/UCEo_vtrFwvVTtxeFf0vsgKg?view_as=subscriber">
                                    <i class="font-icon icon-youtube"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/AdennyFernandes">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            adennyferpw@gmail.com
                        </li>
                        <li>
                            <span class="overhead">Telefone</span><a
                                href="https://api.whatsapp.com/send?phone=5527992362609">+55 (27) 992362609
                            </a>
                        </li>
                    </ul>
                    <ul class="header__contact">
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Adenny Fernandes</footer>
                </div>
            </div>
        </div>
    </main>
